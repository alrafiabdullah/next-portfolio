    ...
    >
      <div className="mx-auto flex max-w-5xl flex-col items-center gap-3 px-5 py-6 sm:flex-row sm:justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <a href="https://abdullahalrafi.medium.com"
            target="_blank"
            rel="noopener noreferrer"
            className="no-underline transition-colors duration-300"
            style={{ color: "var(--color-text-secondary)" }}
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path
                d="M2.846 6.887c.03-.295-.083-.586-.303-.784l-2.24-2.7v-.403h6.958l5.378 11.795 4.728-11.795H24v.403l-1.916 2.452c-.236.19-.365.49-.35.795v7.722c-.024.31.08.616.3.843l1.96 2.41v.403h-8.08v-.403l1.838-2.316c.214-.265.26-.61.12-.924l-3.88-9.873-4.116 10.3c-.15.357.06.77.412.83l1.623.23v.403H2.846v-.403l1.458-.23a.607.607 0 0 0 .584-.654V6.887z"
